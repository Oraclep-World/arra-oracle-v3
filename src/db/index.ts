...
// Moved to ./errors.ts (side-effect-free) so tool handlers and tests can
// import it without opening the default connection above; re-exported here
// to keep existing call sites working.
export { isDbLockError } from './errors.ts';
